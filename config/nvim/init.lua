...
vim.keymap.set({ 'n', 'i', 's' }, '<Esc>', '<cmd>nohl<CR><Esc>')
...
vim.keymap.set({ 'n' }, '<leader>S', function() Snacks.picker.lsp_workspace_symbols() end, { desc = 'Symbols (workspace)' })
vim.keymap.set({ 'n' }, '<leader>p', function() vim.pack.update() end, { desc = 'vim.pack.update()' })
...
vim.keymap.set({ 'n', 'v' }, 'gF', function() Snacks.gitbrowse() end, { desc = 'Open Git Remote URL' })
