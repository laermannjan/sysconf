return {
    ...
    keys = {
        ...
        { '<leader>bb', '<cmd>Pick buffers<cr>', desc = 'Buffers' },
        ...
        { '<leader>fD', '<cmd>Pick diagnostic scope="all"<cr>', desc = 'Diagnostics (project)' },
        ...
        { '<leader>fl', '<cmd>Pick resume<cr>', desc = 'Resume last search' },
